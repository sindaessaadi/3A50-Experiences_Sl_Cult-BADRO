...
<nav class=\"navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">
        <div class=\"navbar-nav ms-auto p-4 p-lg-0\">
            ...
            <!-- Corrected the link for matching page, using Symfony route -->
            <a href=\"";
        // line 60
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_matching_index");
        yield "\" class=\"nav-item nav-link\">Matching</a> <!-- This links to the matching page -->
        ...
        <!-- Fixed link for the 'Join Now' button -->
        <a href=\"";
        // line 72
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_register");
        yield "\" class=\"btn btn-primary py-4 px-lg-5 d-none d-lg-block\">Join Now<i class=\"fa fa-arrow-right ms-3\"></i></a>
    </div>
</nav>
<!-- Navbar End -->
    ...
    {
        return array (  130 => 72,  115 => 60,  98 => 46,  94 => 45,  48 => 1,);
    }
...
<nav class=\"navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0\">
    ...
    <div class=\"collapse navbar-collapse\" id=\"navbarCollapse\">
        <div class=\"navbar-nav ms-auto p-4 p-lg-0\">
            ...
            <a href=\"about.html\" class=\"nav-item nav-link\">About</a>
            <!-- Corrected the link for matching page, using Symfony route -->
            <a href=\"{{ path('app_matching_index') }}\" class=\"nav-item nav-link\">Matching</a> <!-- This links to the matching page -->
            <div class=\"nav-item dropdown\">
                <a href=\"#\" class=\"nav-link dropdown-toggle\" data-bs-toggle=\"dropdown\">Pages</a>
                <div class=\"dropdown-menu fade-down m-0\">
                    <a href=\"team.html\" class=\"dropdown-item\">Our Team</a>
...
</html>", "base.html.twig", "C:\\Users\\jacem\\Downloads\\badro\\templates\\base.html.twig");
    }
}
